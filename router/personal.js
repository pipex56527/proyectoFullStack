...
router.post('/crearMedico', async (req, res) => {
    if (funcGlobales.validarSesion(req, res, rolPermitido)) {
        ...
        try {
            ...
            //redirige a la pagina de personal médico
...
router.get('/:id', async (req, res) => {
    if (funcGlobales.validarSesion(req, res, rolPermitido)) {
        ...
        try {
            ...
            const personaDB = await Personal.findOne({
                _id: id
            });
...
router.put('/:id', async (req, res) => {
    if (funcGlobales.validarSesion(req, res, rolPermitido)) {
        ...
        try {
            ...
            const personalDB = await Personal.findByIdAndUpdate(id, body, {
...
router.delete('/:id', async (req, res) => {
    if (funcGlobales.validarSesion(req, res, rolPermitido)) {
        ...
        try {
            const personaDB = await Personal.findByIdAndDelete({
                _id: id
            });
            if (personaDB) {
                res.json({
